...
#
# File    : QTM2SI.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= QTM2SI
MODULES         		:= NIVeriStand_main.c QTM2SI_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= QTM2SI.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\QTM2SI_niVeriStand_VxWorks_rtw
