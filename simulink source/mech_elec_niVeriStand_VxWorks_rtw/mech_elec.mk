...
#
# File    : mech_elec.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= mech_elec
MODULES         		:= NIVeriStand_main.c mech_elec_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\DOCUME~1\GitHub\CS_ENT~1\02SIMU~1\mech_elec_niVeriStand_VxWorks_rtw
