...
typedef struct {
  ...
  real_T Saturation6;                  /* '<S9>/Saturation6' */
...
typedef struct {
  ...
  real_T alpha_VSP2d_DWORK1;           /* '<S9>/alpha_VSP2,d' */
  real_T u_BTd_DWORK1;                 /* '<S9>/u_BT,d' */
  real_T u_VSP1d_DWORK1;               /* '<S9>/u_VSP1,d' */
  real_T u_VSP2d_DWORK1;               /* '<S9>/u_VSP2,d' */
  real_T alpha_VSP1d_DWORK1;           /* '<S9>/alpha_VSP1,d' */
  real_T omega_VSP1d_DWORK1;           /* '<S9>/omega_VSP1,d' */
  real_T omega_VSP2d_DWORK1;           /* '<S9>/omega_VSP2,d' */
  ...
  uint8_T alpha_VSP2d_DWORK2[12];      /* '<S9>/alpha_VSP2,d' */
  uint8_T u_BTd_DWORK2[12];            /* '<S9>/u_BT,d' */
  uint8_T u_VSP1d_DWORK2[12];          /* '<S9>/u_VSP1,d' */
  uint8_T u_VSP2d_DWORK2[12];          /* '<S9>/u_VSP2,d' */
  uint8_T alpha_VSP1d_DWORK2[12];      /* '<S9>/alpha_VSP1,d' */
  uint8_T omega_VSP1d_DWORK2[12];      /* '<S9>/omega_VSP1,d' */
  uint8_T omega_VSP2d_DWORK2[12];      /* '<S9>/omega_VSP2,d' */
} DW_ctrl_switch_T;
