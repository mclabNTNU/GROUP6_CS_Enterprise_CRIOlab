...
#
# File    : ctrl_switch.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= ctrl_switch
MODULES         		:= NIVeriStand_main.c ctrl_switch_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\DOCUME~1\GitHub\CS_ENT~1\02SIMU~1\ctrl_switch_niVeriStand_VxWorks_rtw
