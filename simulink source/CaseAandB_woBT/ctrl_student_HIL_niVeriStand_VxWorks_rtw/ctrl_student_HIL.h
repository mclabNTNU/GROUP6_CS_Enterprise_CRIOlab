...
typedef struct {
  ...
  real_T tauAct[3];                    /* '<S8>/actForces1' */
  real_T u_vsp1;                       /* '<S8>/Force2Control' */
  real_T u_vsp2;                       /* '<S8>/Force2Control' */
  real_T alpha1;                       /* '<S8>/Force2Control' */
  real_T alpha2;                       /* '<S8>/Force2Control' */
 ...
 * '<S25>'  : 'ctrl_student_HIL/ThrustAllocationAndSaturation/Force Allocation1'
 * '<S26>'  : 'ctrl_student_HIL/ThrustAllocationAndSaturation/Force2Control'
 * '<S27>'  : 'ctrl_student_HIL/ThrustAllocationAndSaturation/Ramp'
 * '<S28>'  : 'ctrl_student_HIL/ThrustAllocationAndSaturation/actForces1'
