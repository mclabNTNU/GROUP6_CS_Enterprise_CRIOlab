...
void ctrl_student_HIL_output(void)
{
  ...
  /* '<S46>:1:3' */
  x_dss = (rtb_DesPosOut_idx_0 * ctrl_student_HIL_P.Constant1_Value -
  ...
  if (rtmIsMajorTimeStep(ctrl_student_HIL_M)) {
    x_dss = ctrl_student_HIL_P.eta_dot_ini[2];
    x_dss = ctrl_student_HIL_P.eta_dot_ini[0];
    x_dss = ctrl_student_HIL_P.eta_dot_ini[1];
  }
  ...
  p3 = 6;
  x_dss = rtb_M[0];
  if ((rtb_M[1] > x_dss) && (rtb_M[1] > rtb_M[2])) {
    i = 3;
    p2 = 0;
    S_T[0] = rtb_M[1];
    S_T[1] = rtb_M[0];
  ...
  /* Step: '<S72>/Step' */
  x_dss = ctrl_student_HIL_M->Timing.t[0];

  /* Clock: '<S72>/Clock' */
  rtb_Clock = ctrl_student_HIL_M->Timing.t[0];

  /* Step: '<S72>/Step' */
  if (x_dss < ctrl_student_HIL_P.Ramp_start) {
    x_dss = ctrl_student_HIL_P.Step_Y0;
  } else {
    x_dss = ctrl_student_HIL_P.Ramp_slope;
  }
   ...
   *  Sum: '<S72>/Sum'
   */
  x_dss = (rtb_Clock - ctrl_student_HIL_P.Ramp_start) * x_dss +
...
RT_MODEL_ctrl_student_HIL_T *ctrl_student_HIL(void)
{
  ...
  ctrl_student_HIL_M->Sizes.numBlocks = (305);/* Number of blocks */
...
void SetExternalOutputs(double* data, int* TaskSampleHit)
{
  ...
  if (TaskSampleHit[1]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(x_dss,0,0,0);
  } else {
    index += 1;
  }
...
static NI_Parameter NI_ParamList[] DataSection(".NIVS.paramlist") =
{
  ...
  { 13,
    ...
    offsetof(P_ctrl_student_HIL_T, eta_dot_ini), 19, 3, 2, 26, 0 },

  { 14,
    "ctrl_student_hil/tau to CSE mocell (only use for HIL testing)/Constant2/Value",
    offsetof(P_ctrl_student_HIL_T, eta_dot_ini), 19, 3, 2, 28, 0 },

  { 15, "ctrl_student_hil/ObserverGain/Constant1/Value", offsetof
    (P_ctrl_student_HIL_T, l1), 18, 9, 2, 30, 0 },

  { 16, "ctrl_student_hil/ObserverGain/Constant2/Value", offsetof
    (P_ctrl_student_HIL_T, l2), 18, 9, 2, 32, 0 },

  { 17, "ctrl_student_hil/ObserverGain/Constant3/Value", offsetof
    (P_ctrl_student_HIL_T, l3), 18, 9, 2, 34, 0 },

  { 18, "ctrl_student_hil/Lim/Value", offsetof(P_ctrl_student_HIL_T, lim), 28, 4,
    2, 36, 0 },

  { 19, "ctrl_student_hil/Lim2/Value", offsetof(P_ctrl_student_HIL_T, lim_2), 28,
    4, 2, 38, 0 },

  { 20,
    "ctrl_student_hil/ControllerAndParanetrization/Controller1/Controller/Controller/Constant/Value",
    offsetof(P_ctrl_student_HIL_T, m), 46, 1, 2, 40, 0 },

  { 21,
    "ctrl_student_hil/ControllerAndParanetrization/PathParameterization/PathGenerization_Ellips/parameter generator/mu/Value",
    offsetof(P_ctrl_student_HIL_T, mu), 46, 1, 2, 42, 0 },
  ...
  { 22,
    ...
    offsetof(P_ctrl_student_HIL_T, mu), 46, 1, 2, 44, 0 },
  ...
  { 23,
    ...
    offsetof(P_ctrl_student_HIL_T, pd), 24, 8, 2, 46, 0 },

  { 24, "ctrl_student_hil/ThrustAllocationAndSaturation/Ramp/Constant1/Value",
    offsetof(P_ctrl_student_HIL_T, Ramp_X0), 46, 1, 2, 48, 0 },

  { 25, "ctrl_student_hil/ThrustAllocationAndSaturation/Ramp/Step/After",
    offsetof(P_ctrl_student_HIL_T, Ramp_slope), 46, 1, 2, 50, 0 },

  { 26, "ctrl_student_hil/ThrustAllocationAndSaturation/Ramp/Constant/Value",
    offsetof(P_ctrl_student_HIL_T, Ramp_start), 46, 1, 2, 52, 0 },

  { 27, "ctrl_student_hil/ThrustAllocationAndSaturation/Ramp/Step/Time",
    offsetof(P_ctrl_student_HIL_T, Ramp_start), 46, 1, 2, 54, 0 },

  { 28, "ctrl_student_hil/safety zone /Switch1/Threshold", offsetof
    (P_ctrl_student_HIL_T, Switch1_Threshold), 46, 1, 2, 56, 0 },

  { 29, "ctrl_student_hil/DPObserver1/etaHat/etaHat/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, etaHat_IC), 19, 3, 2, 58, 0 },

  { 30, "ctrl_student_hil/Noise generator/Step size/Value", offsetof
    (P_ctrl_student_HIL_T, Stepsize_Value), 46, 1, 2, 60, 0 },

  { 31, "ctrl_student_hil/Noise generator/Downsamplesignal/counter/X0", offsetof
    (P_ctrl_student_HIL_T, counter_X0), 46, 1, 2, 62, 0 },

  { 32, "ctrl_student_hil/Constant/Value", offsetof(P_ctrl_student_HIL_T,
    Constant_Value), 46, 1, 2, 64, 0 },

  { 33,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise x/White Noise/Mean",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Mean), 46, 1, 2, 66, 0 },

  { 34,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise x/White Noise/StdDev",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_StdDev), 46, 1, 2, 68, 0 },

  { 35,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise x/White Noise/Seed",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Seed), 46, 1, 2, 70, 0 },

  { 36,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise y/White Noise/Mean",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Mean_h), 46, 1, 2, 72, 0 },

  { 37,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise y/White Noise/StdDev",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_StdDev_d), 46, 1, 2, 74, 0 },

  { 38,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise y/White Noise/Seed",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Seed_b), 46, 1, 2, 76, 0 },

  { 39,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise psi/White Noise/Mean",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Mean_f), 46, 1, 2, 78, 0 },

  { 40,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise psi/White Noise/StdDev",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_StdDev_g), 46, 1, 2, 80, 0 },

  { 41,
    "ctrl_student_hil/Noise generator/noise generator/Band-limited white noise psi/White Noise/Seed",
    offsetof(P_ctrl_student_HIL_T, WhiteNoise_Seed_l), 46, 1, 2, 82, 0 },

  { 42, "ctrl_student_hil/Noise generator/Sample & hold/Hold/X0", offsetof
    (P_ctrl_student_HIL_T, Hold_X0), 46, 1, 2, 84, 0 },

  { 43, "ctrl_student_hil/Dropout_simulator/Memory2/X0", offsetof
    (P_ctrl_student_HIL_T, Memory2_X0), 46, 1, 2, 86, 0 },

  { 44, "ctrl_student_hil/Dropout_simulator/Memory1/X0", offsetof
    (P_ctrl_student_HIL_T, Memory1_X0), 46, 1, 2, 88, 0 },

  { 45, "ctrl_student_hil/Dropout_simulator/Memory/X0", offsetof
    (P_ctrl_student_HIL_T, Memory_X0), 46, 1, 2, 90, 0 },
  ...
  { 46,
    ...
    offsetof(P_ctrl_student_HIL_T, Gain_Gain), 46, 1, 2, 92, 0 },

  { 47,
    "ctrl_student_hil/ControllerAndParanetrization/PathParameterization/PathGenerization_Ellips/Memory/X0",
    offsetof(P_ctrl_student_HIL_T, Memory_X0_n), 46, 1, 2, 94, 0 },
  ...
  { 51,
    ...
    offsetof(P_ctrl_student_HIL_T, Integrator_IC_p), 46, 1, 2, 102, 0 },
  ...
  { 52,
    ...
    offsetof(P_ctrl_student_HIL_T, Memory2_X0_a), 46, 1, 2, 104, 0 },
  ...
  { 53,
    ...
    offsetof(P_ctrl_student_HIL_T, Memory1_X0_p), 33, 2, 2, 106, 0 },

  { 54,
    "ctrl_student_hil/ControllerAndParanetrization/PathParameterization/Switch/Threshold",
    offsetof(P_ctrl_student_HIL_T, Switch_Threshold), 46, 1, 2, 108, 0 },
  ...
  { 55,
    ...
    offsetof(P_ctrl_student_HIL_T, Constant_Value_k), 46, 1, 2, 110, 0 },
  ...
  { 56,
    ...
    offsetof(P_ctrl_student_HIL_T, Constant1_Value), 46, 1, 2, 112, 0 },

  { 57,
    "ctrl_student_hil/ControllerAndParanetrization/PathParameterization/Switch3/Threshold",
    offsetof(P_ctrl_student_HIL_T, Switch3_Threshold), 46, 1, 2, 114, 0 },
  ...
  { 58,
    ...
    offsetof(P_ctrl_student_HIL_T, Gain_Gain_a), 46, 1, 2, 116, 0 },

  { 59,
    "ctrl_student_hil/ControllerAndParanetrization/PathParameterization/PathGenerization_Straight/IC/Value",
    offsetof(P_ctrl_student_HIL_T, IC_Value_e), 46, 1, 2, 118, 0 },

  { 60,
    "ctrl_student_hil/ControllerAndParanetrization/PathParameterization/Switch4/Threshold",
    offsetof(P_ctrl_student_HIL_T, Switch4_Threshold), 46, 1, 2, 120, 0 },

  { 61, "ctrl_student_hil/DPObserver1/Subsystem/nuHat/InitialCondition",
    offsetof(P_ctrl_student_HIL_T, nuHat_IC), 19, 3, 2, 122, 0 },

  { 62,
    "ctrl_student_hil/ControllerAndParanetrization/PathParameterization/Switch5/Threshold",
    offsetof(P_ctrl_student_HIL_T, Switch5_Threshold), 46, 1, 2, 124, 0 },
  ...
  { 63,
    ...
    offsetof(P_ctrl_student_HIL_T, Constant_Value_o), 46, 1, 2, 126, 0 },
  ...
  { 64,
    ...
    offsetof(P_ctrl_student_HIL_T, Constant1_Value_l), 46, 1, 2, 128, 0 },
  ...
  { 65,
    ...
    offsetof(P_ctrl_student_HIL_T, Constant2_Value), 46, 1, 2, 130, 0 },

  { 66,
    "ctrl_student_hil/ControllerAndParanetrization/PathParameterization/Switch6/Threshold",
    offsetof(P_ctrl_student_HIL_T, Switch6_Threshold), 46, 1, 2, 132, 0 },
  ...
  { 67,
    ...
    offsetof(P_ctrl_student_HIL_T, Constant3_Value), 46, 1, 2, 134, 0 },

  { 68,
    "ctrl_student_hil/ControllerAndParanetrization/PathParameterization/Switch7/Threshold",
    offsetof(P_ctrl_student_HIL_T, Switch7_Threshold), 46, 1, 2, 136, 0 },

  { 69,
    "ctrl_student_hil/ControllerAndParanetrization/Controller1/Constant1/Value",
    offsetof(P_ctrl_student_HIL_T, Constant1_Value_d), 46, 1, 2, 138, 0 },

  { 70,
    "ctrl_student_hil/ControllerAndParanetrization/Controller1/Constant/Value",
    offsetof(P_ctrl_student_HIL_T, Constant_Value_d), 19, 3, 2, 140, 0 },

  { 71,
    "ctrl_student_hil/ControllerAndParanetrization/Controller1/Controller/Switch2/Threshold",
    offsetof(P_ctrl_student_HIL_T, Switch2_Threshold), 46, 1, 2, 142, 0 },

  { 72, "ctrl_student_hil/joystick/Memory1/X0", offsetof(P_ctrl_student_HIL_T,
    Memory1_X0_j), 46, 1, 2, 144, 0 },

  { 73, "ctrl_student_hil/joystick/Max_Global_Forces/Value", offsetof
    (P_ctrl_student_HIL_T, Max_Global_Forces_Value), 34, 4, 2, 146, 0 },
  ...
  { 82, "ctrl_student_hil/Switch3/Threshold", offsetof(P_ctrl_student_HIL_T,
    Switch3_Threshold_a), 46, 1, 2, 164, 0 },

  { 83, "ctrl_student_hil/safety zone /Switch/Threshold", offsetof
    (P_ctrl_student_HIL_T, Switch_Threshold_n), 46, 1, 2, 166, 0 },

  { 84, "ctrl_student_hil/safety zone /Memory/X0", offsetof(P_ctrl_student_HIL_T,
    Memory_X0_i), 46, 1, 2, 168, 0 },

  { 85, "ctrl_student_hil/safety zone /Switch2/Threshold", offsetof
    (P_ctrl_student_HIL_T, Switch2_Threshold_p), 46, 1, 2, 170, 0 },

  { 86, "ctrl_student_hil/Constant1/Value", offsetof(P_ctrl_student_HIL_T,
    Constant1_Value_i), 46, 1, 2, 172, 0 },

  { 87, "ctrl_student_hil/Switch1/Threshold", offsetof(P_ctrl_student_HIL_T,
    Switch1_Threshold_l), 46, 1, 2, 174, 0 },

  { 88,
    "ctrl_student_hil/ThrustAllocationAndSaturation/Actuator_Sat_Forces/Value",
    offsetof(P_ctrl_student_HIL_T, Actuator_Sat_Forces_Value), 33, 2, 2, 176, 0
  },
  ...
  { 89,
    ...
    offsetof(P_ctrl_student_HIL_T, Memory_X0_j), 46, 1, 2, 178, 0 },

  { 90, "ctrl_student_hil/DPObserver1/Bias/Constant/Value", offsetof
    (P_ctrl_student_HIL_T, Constant_Value_e), 19, 3, 2, 180, 0 },

  { 91, "ctrl_student_hil/DPObserver1/Bias/bHat/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, bHat_IC), 46, 1, 2, 182, 0 },

  { 92, "ctrl_student_hil/DPObserver1/Bias/IC1/Value", offsetof
    (P_ctrl_student_HIL_T, IC1_Value), 19, 3, 2, 184, 0 },

  { 93, "ctrl_student_hil/DPObserver1/Subsystem/IC/Value", offsetof
    (P_ctrl_student_HIL_T, IC_Value_f), 19, 3, 2, 186, 0 },

  { 94, "ctrl_student_hil/ThrustAllocationAndSaturation/Constant/Value",
    offsetof(P_ctrl_student_HIL_T, Constant_Value_ks), 46, 1, 2, 188, 0 },

  { 95, "ctrl_student_hil/ThrustAllocationAndSaturation/Ramp/Step/Before",
    offsetof(P_ctrl_student_HIL_T, Step_Y0), 46, 1, 2, 190, 0 },

  { 96, "ctrl_student_hil/ThrustAllocationAndSaturation/Saturation/UpperLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_UpperSat), 46, 1, 2, 192, 0 },

  { 97, "ctrl_student_hil/ThrustAllocationAndSaturation/Saturation/LowerLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_LowerSat), 46, 1, 2, 194, 0 },

  { 98, "ctrl_student_hil/ThrustAllocationAndSaturation/Switch/Threshold",
    offsetof(P_ctrl_student_HIL_T, Switch_Threshold_j), 46, 1, 2, 196, 0 },

  { 99, "ctrl_student_hil/ThrustAllocationAndSaturation/Constant1/Value",
    offsetof(P_ctrl_student_HIL_T, Constant1_Value_o), 46, 1, 2, 198, 0 },

  { 100, "ctrl_student_hil/ThrustAllocationAndSaturation/Switch1/Threshold",
    offsetof(P_ctrl_student_HIL_T, Switch1_Threshold_o), 46, 1, 2, 200, 0 },

  { 101, "ctrl_student_hil/physics_model/Integrator/InitialCondition", offsetof
    (P_ctrl_student_HIL_T, Integrator_IC_m), 19, 3, 2, 202, 0 },
};

static int NI_ParamListSize DataSection(".NIVS.paramlistsize") = 102;
static int NI_ParamDimList[] DataSection(".NIVS.paramdimlist") =
{
  ...
  3, 1,                                /* Parameter at index 14 */
  3, 3,                                /* Parameter at index 15 */
  3, 3,                                /* Parameter at index 16 */
  3, 3,                                /* Parameter at index 17 */
  4, 1,                                /* Parameter at index 18 */
  4, 1,                                /* Parameter at index 19 */
  1, 1,                                /* Parameter at index 20 */
  1, 1,                                /* Parameter at index 21 */
  1, 1,                                /* Parameter at index 22 */
  2, 4,                                /* Parameter at index 23 */
...
static char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "ctrl_student_hil";
static char* NI_CompiledModelVersion = "1.286";
static char* NI_CompiledModelDateTime = "Sun Apr 02 15:12:52 2017";
