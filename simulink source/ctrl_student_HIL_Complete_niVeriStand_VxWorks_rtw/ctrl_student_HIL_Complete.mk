...
#
# File    : ctrl_student_HIL_Complete.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= ctrl_student_HIL_Complete
MODULES         		:= NIVeriStand_main.c ctrl_student_HIL_Complete_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE        		:= ctrl_student_HIL_Complete.mk
...
MODELLIB                  := ctrl_student_HIL_Completelib.lib
MODELREF_LINK_LIBS   	  := 
MODELREF_INC_PATH         := 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\MCLab\DOCUME~1\GitHub\GROUP6~1\SIMULI~1\ctrl_student_HIL_Complete_niVeriStand_VxWorks_rtw
