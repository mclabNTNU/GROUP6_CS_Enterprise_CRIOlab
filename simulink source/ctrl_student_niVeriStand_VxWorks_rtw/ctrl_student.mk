...
#
# File    : ctrl_student.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= ctrl_student
MODULES         		:= NIVeriStand_main.c ctrl_student_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\MCLab\DOCUME~1\GitHub\CS_ENT~2\SIMULI~1\ctrl_student_niVeriStand_VxWorks_rtw
