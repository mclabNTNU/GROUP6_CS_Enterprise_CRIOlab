...
#endif                                 /* CSEI_u_COMMON_INCLUDES_ */

#include "CSEI_u_types.h"
...
#define CSEI_u_rtModel                 RT_MODEL_CSEI_u_T
...
typedef struct {
  ...
  real_T Memory5;                      /* '<S4>/Memory5' */
  real_T Position[3];                  /* '<Root>/Position' */
  real_T Velocity[3];                  /* '<Root>/Velocity' */
  real_T u_BT;                         /* '<S10>/u_BT' */
  real_T u_VSP1;                       /* '<S10>/u_VSP1' */
  real_T u_VSP2;                       /* '<S10>/u_VSP2' */
  real_T alpha_VSP1;                   /* '<S10>/alpha_VSP1' */
  real_T alpha_VSP2;                   /* '<S10>/alpha_VSP2' */
  real_T omega_VSP1;                   /* '<S10>/omega_VSP1' */
  real_T omega_VSP2;                   /* '<S10>/omega_VSP2' */
  real_T psi_0;                        /* '<S4>/psi_0' */
  real_T x_0;                          /* '<S4>/x_0' */
  real_T y_0;                          /* '<S4>/y_0' */
...
typedef struct {
  ...
  real_T Memory5_PreviousInput;        /* '<S4>/Memory5' */
  real_T x_DWORK1;                     /* '<S3>/x' */
  real_T y_DWORK1;                     /* '<S3>/y' */
  real_T psi_DWORK1;                   /* '<S3>/psi' */
  real_T r_DWORK1;                     /* '<S7>/r' */
  real_T u_DWORK1;                     /* '<S7>/u' */
  real_T v_DWORK1;                     /* '<S7>/v' */
  ...
  uint8_T integrator_reset_DWORK2[7];  /* '<Root>/integrator_reset' */
  uint8_T x_DWORK2[7];                 /* '<S3>/x' */
  uint8_T y_DWORK2[7];                 /* '<S3>/y' */
  uint8_T psi_DWORK2[7];               /* '<S3>/psi' */
  uint8_T r_DWORK2[7];                 /* '<S7>/r' */
  uint8_T u_DWORK2[7];                 /* '<S7>/u' */
  uint8_T v_DWORK2[7];                 /* '<S7>/v' */
  uint8_T u_BT_DWORK2[7];              /* '<S10>/u_BT' */
  uint8_T u_VSP1_DWORK2[7];            /* '<S10>/u_VSP1' */
  uint8_T u_VSP2_DWORK2[7];            /* '<S10>/u_VSP2' */
  uint8_T alpha_VSP1_DWORK2[7];        /* '<S10>/alpha_VSP1' */
  uint8_T alpha_VSP2_DWORK2[7];        /* '<S10>/alpha_VSP2' */
  uint8_T omega_VSP1_DWORK2[7];        /* '<S10>/omega_VSP1' */
  uint8_T omega_VSP2_DWORK2[7];        /* '<S10>/omega_VSP2' */
  uint8_T r_dot_DWORK2[7];             /* '<S8>/r_dot' */
  uint8_T u_dot_DWORK2[7];             /* '<S8>/u_dot' */
  uint8_T v_dot_DWORK2[7];             /* '<S8>/v_dot' */
  uint8_T X_DWORK2[7];                 /* '<S9>/X' */
  uint8_T Y_DWORK2[7];                 /* '<S9>/Y' */
  uint8_T N_DWORK2[7];                 /* '<S9>/N' */
  uint8_T psi_0_DWORK2[7];             /* '<S4>/psi_0' */
  uint8_T x_0_DWORK2[7];               /* '<S4>/x_0' */
  uint8_T y_0_DWORK2[7];               /* '<S4>/y_0' */
} DW_CSEI_u_T;
...
typedef struct {
  ZCSigState Position_Reset_ZCE;       /* '<Root>/Position' */
  ZCSigState Velocity_Reset_ZCE;       /* '<Root>/Velocity' */
} PrevZCX_CSEI_u_T;
...
#define rtB                            CSEI_u_B
#define BlockIO                        B_CSEI_u_T
#define rtX                            CSEI_u_X
#define ContinuousStates               X_CSEI_u_T
#define rtXdot                         CSEI_u_XDot
#define StateDerivatives               XDot_CSEI_u_T
#define tXdis                          CSEI_u_XDis
#define StateDisabled                  XDis_CSEI_u_T
#define rtP                            CSEI_u_P
#define Parameters                     P_CSEI_u_T
#define rtDWork                        CSEI_u_DW
#define D_Work                         DW_CSEI_u_T
#define rtPrevZCSigState               CSEI_u_PrevZCX
#define PrevZCSigStates                PrevZCX_CSEI_u_T
...
extern P_CSEI_u_T CSEI_u_P;

/* Block signals (auto storage) */
extern B_CSEI_u_T CSEI_u_B;

/* Continuous states (auto storage) */
extern X_CSEI_u_T CSEI_u_X;

/* Block states (auto storage) */
extern DW_CSEI_u_T CSEI_u_DW;

/* Model entry point functions */
extern void CSEI_u_initialize(void);
 ...
 *
 * '<Root>' : 'CSEI_u'
 * '<S1>'   : 'CSEI_u/B Command to force mapping'
 * '<S2>'   : 'CSEI_u/T Thruster configuration matrix'
 * '<S3>'   : 'CSEI_u/eta'
 * '<S4>'   : 'CSEI_u/eta_0'
 * '<S5>'   : 'CSEI_u/kinematics'
 * '<S6>'   : 'CSEI_u/kinetics'
 * '<S7>'   : 'CSEI_u/nu'
 * '<S8>'   : 'CSEI_u/nu_dot'
 * '<S9>'   : 'CSEI_u/tau'
 * '<S10>'  : 'CSEI_u/u'
 * '<S11>'  : 'CSEI_u/B Command to force mapping/Bow thruster'
 * '<S12>'  : 'CSEI_u/B Command to force mapping/VSP'
 */
#endif                                 /* RTW_HEADER_CSEI_u_h_ */
...
P_CSEI_u_T rtParameter[NUMST+!TID01EQ];
P_CSEI_u_T *param_lookup[NUMST][2] = {
...
extern int tid;
extern P_CSEI_u_T* param_lookup[NUMST][2];

#else

extern P_CSEI_u_T rtParameter[];

#endif
#endif

#ifdef MULTITASKING
#define CSEI_u_P                       (*param_lookup[tid][READSIDE])
#else
#define CSEI_u_P                       rtParameter[READSIDE]
#endif
#endif
#endif
