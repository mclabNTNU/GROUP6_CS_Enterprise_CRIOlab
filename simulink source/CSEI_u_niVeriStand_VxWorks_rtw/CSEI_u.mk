...
#
# File    : CSEI_u.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= CSEI_u
MODULES         		:= CSEI_u_data.c NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE        		:= CSEI_u.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\DOCUME~1\GitHub\CS_ENT~2\SIMULI~1\CSEI_u_niVeriStand_VxWorks_rtw
