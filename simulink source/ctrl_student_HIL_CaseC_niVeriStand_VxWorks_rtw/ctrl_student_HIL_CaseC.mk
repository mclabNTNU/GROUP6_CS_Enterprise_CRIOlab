...
#
# File    : ctrl_student_HIL_CaseC.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= ctrl_student_HIL_CaseC
MODULES         		:= NIVeriStand_main.c ctrl_student_HIL_CaseC_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE        		:= ctrl_student_HIL_CaseC.mk
...
MODELLIB                  := ctrl_student_HIL_CaseClib.lib
MODELREF_LINK_LIBS   	  := 
MODELREF_INC_PATH         := 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\MCLab\DOCUME~1\GitHub\GROUP6~1\SIMULI~1\ctrl_student_HIL_CaseC_niVeriStand_VxWorks_rtw
