...
typedef struct {
  ...
  real_T WhiteNoise_e;                 /* '<S28>/White Noise' */
  real_T NoisePowHead;                 /* '<Root>/NoisePowHead' */
  real_T WhiteNoise_m;                 /* '<S26>/White Noise' */
  ...
  real_T X_out;                        /* '<S4>/MATLAB Function' */
  real_T Y_out;                        /* '<S4>/MATLAB Function' */
  real_T Yaw_out;                      /* '<S4>/MATLAB Function' */
  real_T etaHatDot[3];                 /* '<S13>/etaHatDot' */
  real_T nuHatDot[3];                  /* '<S12>/nuHatDot' */
  real_T bHatDot[3];                   /* '<S9>/bHatDot' */
...
typedef struct {
  ...
  real_T NextOutput_c;                 /* '<S28>/White Noise' */
  real_T NoisePowHead_DWORK1;          /* '<Root>/NoisePowHead' */
  real_T NextOutput_p;                 /* '<S26>/White Noise' */
  ...
  real_T IC1_FirstOutputTime;          /* '<S9>/IC1' */
  ...
  uint32_T RandSeed_c;                 /* '<S26>/White Noise' */
  uint8_T eta_hat_DWORK2[23];          /* '<Root>/eta_hat' */
  uint8_T y_in_DWORK2[23];             /* '<Root>/y_in' */
  uint8_T psi_in_DWORK2[23];           /* '<Root>/psi_in' */
  uint8_T u_in_DWORK2[23];             /* '<Root>/u_in' */
  uint8_T u_real_DWORK2[23];           /* '<Root>/u_real  ' */
  uint8_T x_in_DWORK2[23];             /* '<Root>/x_in' */
  uint8_T eta_tilde_DWORK2[23];        /* '<Root>/eta_tilde' */
  uint8_T NoisePowPos_DWORK2[23];      /* '<Root>/NoisePowPos' */
  uint8_T NoisePowHead_DWORK2[23];     /* '<Root>/NoisePowHead' */
  uint8_T NoiseEnable_DWORK2[23];      /* '<Root>/NoiseEnable' */
  uint8_T Dropout_signaINl_DWORK2[23]; /* '<Root>/Dropout_signaINl' */
  uint8_T eta_noise_DWORK2[23];        /* '<Root>/eta_noise' */
  uint8_T r_in_DWORK2[23];             /* '<Root>/r_in' */
  uint8_T Dropout_signaOUT_DWORK2[23]; /* '<Root>/Dropout_signaOUT' */
  uint8_T sf1_DWORK2[23];              /* '<Root>/sf1' */
  uint8_T v_in_DWORK2[23];             /* '<Root>/v_in' */
  uint8_T sf2_DWORK2[23];              /* '<Root>/sf2' */
  uint8_T sf3_DWORK2[23];              /* '<Root>/sf3' */
  uint8_T biasOffset_DWORK2[23];       /* '<Root>/biasOffset' */
  uint8_T reset_DWORK2[23];            /* '<Root>/reset' */
  uint8_T L2_continuous_DWORK2[23];    /* '<S7>/L2_continuous' */
  uint8_T Select_DWORK2[23];           /* '<S7>/Select' */
  ...
  uint8_T CurrentMode_DWORK2[23];      /* '<S7>/Current Mode ' */
  uint8_T R1_DWORK2[23];               /* '<S7>/R1' */
  uint8_T ErrorStateFlag_DWORK2[23];   /* '<S7>/Error State Flag' */
  uint8_T ArrowDown_DWORK2[23];        /* '<S7>/ArrowDown' */
  uint8_T f_vspx_DWORK2[23];           /* '<S7>/f_vspx' */
  uint8_T ArrowUp_DWORK2[23];          /* '<S7>/ArrowUp' */
  uint8_T f_vspy_DWORK2[23];           /* '<S7>/f_vspy' */
  uint8_T ArrowLeft_DWORK2[23];        /* '<S7>/ArrowLeft' */
  uint8_T f_bt_DWORK2[23];             /* '<S7>/f_bt' */
  uint8_T ArrowRight_DWORK2[23];       /* '<S7>/ArrowRight' */
  uint8_T tau_yaw_DWORK2[23];          /* '<S7>/tau_yaw' */
  uint8_T tau_x_DWORK2[23];            /* '<S7>/tau_x' */
  uint8_T tau_y_DWORK2[23];            /* '<S7>/tau_y' */
...
typedef struct {
  real_T etaHat_CSTATE[3];             /* '<S13>/etaHat' */
  real_T bHat_CSTATE[3];               /* '<S9>/bHat' */
  real_T nuHat_CSTATE[3];              /* '<S12>/nuHat' */
...
/* State disabled  */
typedef struct {
  boolean_T etaHat_CSTATE[3];          /* '<S13>/etaHat' */
  boolean_T bHat_CSTATE[3];            /* '<S9>/bHat' */
  boolean_T nuHat_CSTATE[3];           /* '<S12>/nuHat' */
...
struct P_ctrl_student_HIL_CaseC_T_ {
  ...
  real_T integratorresetmodel_P6;      /* Expression: btype
                                        * Referenced by: '<S8>/integrator reset model'
                                        */
  real_T Constant_Value_d[3];          /* Expression: [1;1;1]
 ...
 * '<S1>'   : 'ctrl_student_HIL_CaseC/DPObserver'
 * '<S2>'   : 'ctrl_student_HIL_CaseC/DropOut_detector'
 * '<S3>'   : 'ctrl_student_HIL_CaseC/DropoutAction'
 * '<S4>'   : 'ctrl_student_HIL_CaseC/Dropout_simulator'
 * '<S5>'   : 'ctrl_student_HIL_CaseC/Noise generator'
 * '<S6>'   : 'ctrl_student_HIL_CaseC/Real Velocity'
 * '<S7>'   : 'ctrl_student_HIL_CaseC/joystick'
 * '<S8>'   : 'ctrl_student_HIL_CaseC/tau to CSE mocell (only use for HIL testing)'
 * '<S9>'   : 'ctrl_student_HIL_CaseC/DPObserver/Bias'
 * '<S10>'  : 'ctrl_student_HIL_CaseC/DPObserver/D'
 * '<S11>'  : 'ctrl_student_HIL_CaseC/DPObserver/Rotation Matrix'
 * '<S12>'  : 'ctrl_student_HIL_CaseC/DPObserver/Subsystem'
 * '<S13>'  : 'ctrl_student_HIL_CaseC/DPObserver/etaHat'
 * '<S14>'  : 'ctrl_student_HIL_CaseC/DPObserver/Bias/bHatDot'
 * '<S15>'  : 'ctrl_student_HIL_CaseC/DPObserver/Subsystem/M'
 * '<S16>'  : 'ctrl_student_HIL_CaseC/DPObserver/Subsystem/nuHatDot'
 * '<S17>'  : 'ctrl_student_HIL_CaseC/DPObserver/etaHat/etaHatDot'
 * '<S18>'  : 'ctrl_student_HIL_CaseC/DropOut_detector/dropoutDetect'
 * '<S19>'  : 'ctrl_student_HIL_CaseC/DropoutAction/accInjection'
 * '<S20>'  : 'ctrl_student_HIL_CaseC/Dropout_simulator/MATLAB Function'
 * '<S21>'  : 'ctrl_student_HIL_CaseC/Noise generator/Downsample	signal'
 * '<S22>'  : 'ctrl_student_HIL_CaseC/Noise generator/Sample & hold'
 * '<S23>'  : 'ctrl_student_HIL_CaseC/Noise generator/noise generator'
 * '<S24>'  : 'ctrl_student_HIL_CaseC/Noise generator/Downsample	signal/MATLAB Function'
 * '<S25>'  : 'ctrl_student_HIL_CaseC/Noise generator/Sample & hold/MATLAB Function1'
 * '<S26>'  : 'ctrl_student_HIL_CaseC/Noise generator/noise generator/Band-limited white noise psi'
 * '<S27>'  : 'ctrl_student_HIL_CaseC/Noise generator/noise generator/Band-limited white noise x'
 * '<S28>'  : 'ctrl_student_HIL_CaseC/Noise generator/noise generator/Band-limited white noise y'
 * '<S29>'  : 'ctrl_student_HIL_CaseC/joystick/Contoller_Map'
 * '<S30>'  : 'ctrl_student_HIL_CaseC/joystick/Force Allocation'
 * '<S31>'  : 'ctrl_student_HIL_CaseC/joystick/Force2Control'
 * '<S32>'  : 'ctrl_student_HIL_CaseC/joystick/Ramp'
 * '<S33>'  : 'ctrl_student_HIL_CaseC/joystick/Sat_Chk_BT'
 * '<S34>'  : 'ctrl_student_HIL_CaseC/joystick/Sat_Chk_VSP'
 * '<S35>'  : 'ctrl_student_HIL_CaseC/joystick/Sel_Control_Mode'
 */
