...
#
# File    : ctrl_DP_basic.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= ctrl_DP_basic
MODULES         		:= NIVeriStand_main.c ctrl_DP_basic_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c rt_zcfcn.c 
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\ctrl_DP_basic_niVeriStand_VxWorks_rtw
