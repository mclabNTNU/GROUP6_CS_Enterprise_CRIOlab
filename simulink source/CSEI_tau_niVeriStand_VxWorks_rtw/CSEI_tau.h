...
#ifndef RTW_HEADER_CSEI_tau_h_
#define RTW_HEADER_CSEI_tau_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef CSEI_tau_COMMON_INCLUDES_
# define CSEI_tau_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "zero_crossing_types.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* CSEI_tau_COMMON_INCLUDES_ */

#include "CSEI_tau_types.h"
...
typedef struct {
  ...
  real_T psi_DWORK1;                   /* '<S1>/psi' */
  real_T u_DWORK1;                     /* '<S5>/u' */
  real_T v_DWORK1;                     /* '<S5>/v' */
  real_T r_DWORK1;                     /* '<S5>/r' */
  real_T psi_0_DWORK1;                 /* '<S2>/psi_0' */
  real_T x_0_DWORK1;                   /* '<S2>/x_0' */
  real_T y_0_DWORK1;                   /* '<S2>/y_0' */
  ...
  } Integrator1_IWORK;                 /* '<Root>/Integrator1' */

  uint8_T integrator_reset_DWORK2[9];  /* '<Root>/integrator_reset' */
  uint8_T x_DWORK2[9];                 /* '<S1>/x' */
  uint8_T y_DWORK2[9];                 /* '<S1>/y' */
  uint8_T psi_DWORK2[9];               /* '<S1>/psi' */
  uint8_T u_DWORK2[9];                 /* '<S5>/u' */
  uint8_T v_DWORK2[9];                 /* '<S5>/v' */
  uint8_T r_DWORK2[9];                 /* '<S5>/r' */
  uint8_T psi_0_DWORK2[9];             /* '<S2>/psi_0' */
  uint8_T x_0_DWORK2[9];               /* '<S2>/x_0' */
  uint8_T y_0_DWORK2[9];               /* '<S2>/y_0' */
  uint8_T X_DWORK2[9];                 /* '<S6>/X' */
  uint8_T Y_DWORK2[9];                 /* '<S6>/Y' */
  uint8_T N_DWORK2[9];                 /* '<S6>/N' */
} DW_CSEI_tau_T;
...
#define rtB                            CSEI_tau_B
#define BlockIO                        B_CSEI_tau_T
#define rtX                            CSEI_tau_X
#define ContinuousStates               X_CSEI_tau_T
#define rtXdot                         CSEI_tau_XDot
#define StateDerivatives               XDot_CSEI_tau_T
#define tXdis                          CSEI_tau_XDis
#define StateDisabled                  XDis_CSEI_tau_T
#define rtP                            CSEI_tau_P
#define Parameters                     P_CSEI_tau_T
#define rtDWork                        CSEI_tau_DW
#define D_Work                         DW_CSEI_tau_T
#define rtPrevZCSigState               CSEI_tau_PrevZCX
#define PrevZCSigStates                PrevZCX_CSEI_tau_T

/* Parameters (auto storage) */
struct P_CSEI_tau_T_ {
...
extern P_CSEI_tau_T CSEI_tau_P;

/* Block signals (auto storage) */
extern B_CSEI_tau_T CSEI_tau_B;

/* Continuous states (auto storage) */
extern X_CSEI_tau_T CSEI_tau_X;

/* Block states (auto storage) */
extern DW_CSEI_tau_T CSEI_tau_DW;

/* Model entry point functions */
extern void CSEI_tau_initialize(void);
extern void CSEI_tau_output(void);
extern void CSEI_tau_update(void);
extern void CSEI_tau_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern CSEI_tau_rtModel *CSEI_tau(void);
...
extern RT_MODEL_CSEI_tau_T *const CSEI_tau_M;
 ...
 * '<S1>'   : 'CSEI_tau/eta'
 * '<S2>'   : 'CSEI_tau/eta_0'
 * '<S3>'   : 'CSEI_tau/kinematics'
 * '<S4>'   : 'CSEI_tau/kinetics'
 * '<S5>'   : 'CSEI_tau/nu'
 * '<S6>'   : 'CSEI_tau/tau'
 */
#endif                                 /* RTW_HEADER_CSEI_tau_h_ */
...
P_CSEI_tau_T rtParameter[NUMST+!TID01EQ];
P_CSEI_tau_T *param_lookup[NUMST][2] = {
...
extern int tid;
extern P_CSEI_tau_T* param_lookup[NUMST][2];

#else

extern P_CSEI_tau_T rtParameter[];

#endif
#endif

#ifdef MULTITASKING
#define CSEI_tau_P                     (*param_lookup[tid][READSIDE])
#else
#define CSEI_tau_P                     rtParameter[READSIDE]
#endif
#endif
#endif
