...
#
# File    : CSE1_HIL_tau.mk (for Release 2007b and later)
#
# Abstract:
...
MODEL           		:= CSE1_HIL_tau
MODULES         		:= CSE1_HIL_tau_data.c NIVeriStand_main.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE        		:= CSE1_HIL_tau.mk
...
MATLAB_INCLUDES := $(MATLAB_INCLUDES) -IC:\Users\mclab\Dropbox\TMR424~1\06CSE1~1\CSE1_HIL_tau_niVeriStand_VxWorks_rtw
