...
typedef struct {
  ...
  real_T WhiteNoise_e;                 /* '<S20>/White Noise' */
  real_T NoisePowHead;                 /* '<Root>/NoisePowHead' */
  real_T WhiteNoise_m;                 /* '<S18>/White Noise' */
...
typedef struct {
  ...
  real_T imu_in_DWORK1;                /* '<Root>/imu_in' */
  ...
  uint8_T imu_in_DWORK2[17];           /* '<Root>/imu_in' */
...
struct P_ctrl_student_HIL_T_ {
  ...
  real_T Constant2_Value;              /* Expression: 0
                                        ...
                                        */
  real_T Constant3_Value;              /* Expression: 6.45
  ...
  real_T integratorresetmodel_P6;      /* Expression: btype
                                        * Referenced by: '<S10>/integrator reset model'
                                        */
  real_T imu_in_P1;                    /* Expression: width
                                        * Referenced by: '<Root>/imu_in'
                                        */
  real_T imu_in_P2;                    /* Expression: dtype
                                        * Referenced by: '<Root>/imu_in'
                                        */
  real_T imu_in_P3;                    /* Expression: portnum
                                        * Referenced by: '<Root>/imu_in'
                                        */
  real_T imu_in_P4;                    /* Expression: stime
                                        * Referenced by: '<Root>/imu_in'
                                        */
  real_T imu_in_P5;                    /* Expression: stype
                                        * Referenced by: '<Root>/imu_in'
                                        */
  real_T imu_in_P6;                    /* Expression: btype
                                        * Referenced by: '<Root>/imu_in'
                                        */
  real_T Gain_Gain_e;                  /* Expression: 0.1
 ...
 * '<S21>'  : 'ctrl_student_HIL/Observer/D_11(u)//M'
 * '<S22>'  : 'ctrl_student_HIL/Observer/Term3'
 * '<S23>'  : 'ctrl_student_HIL/Subsystem/accInjection'
