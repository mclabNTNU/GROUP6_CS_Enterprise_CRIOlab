...
typedef struct {
  ...
  real_T Memory_PreviousInput_m;       /* '<S3>/Memory' */
...
typedef struct {
  ...
  real_T Integrator_CSTATE_g;          /* '<S2>/Integrator' */
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_g;       /* '<S2>/Integrator' */
