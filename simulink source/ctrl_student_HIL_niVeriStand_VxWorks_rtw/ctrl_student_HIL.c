...
void ctrl_student_HIL_output(void)
{
  ...
  for (rtb_switch_sig = 0; rtb_switch_sig < 3; rtb_switch_sig++) {
    rtb_Product_j[rtb_switch_sig] = rtb_R[rtb_switch_sig + 6] *
      ctrl_student_HIL_B.TmpSignalConversionAtTau_preInp[2] +
      (rtb_R[rtb_switch_sig + 3] *
       ctrl_student_HIL_B.TmpSignalConversionAtTau_preInp[1] +
       rtb_R[rtb_switch_sig] *
       ctrl_student_HIL_B.TmpSignalConversionAtTau_preInp[0]);
  }
   ...
   */
  for (rtb_switch_sig = 0; rtb_switch_sig < 3; rtb_switch_sig++) {
    rtb_Switch[rtb_switch_sig] = rtb_R[rtb_switch_sig + 6] *
      ctrl_student_HIL_B.r_in + (rtb_R[rtb_switch_sig + 3] *
      ctrl_student_HIL_B.v_in + rtb_R[rtb_switch_sig] * ctrl_student_HIL_B.u_in);
  }
  ...
  /* K=[1;1];     */
  if ((rtb_Saturation == 0.0) && (rtb_DeadZone == 0.0) && (rtb_safety_sig_3 ==
       0.0) && (rtb_safety_sig_4 == 0)) {
    /* '<S36>:1:7' */
    ...
    if ((rtb_Saturation == 1.0) || (rtb_DeadZone == 1.0)) {
      /* '<S36>:1:16' */
      /* Problem in X dir */
    ...
    /* IF   */
    if ((rtb_safety_sig_3 == 1.0) || (rtb_safety_sig_4 == 1)) {
      /* '<S36>:1:49' */
      ...
      if (rtb_Product_j[1] == 0.0) {
        ...
        } else if ((rtb_Switch[1] < 0.0) && (rtb_safety_sig_4 == 1)) {
          /* '<S36>:1:56' */
          /* '<S36>:1:57' */
          rtb_Saturation = ctrl_student_HIL_P.K[1] * -rtb_Switch[1];
      ...
      } else if ((rtb_Product_j[1] > 0.0) && (rtb_safety_sig_4 == 1)) {
        /* '<S36>:1:65' */
        /* Y cord to small */
        /* '<S36>:1:66' */
        rtb_Saturation = rtb_Product_j[1];
  ...
  if (rtb_switch_sig == 1) {
    ...
    rtb_safety_sig_3 = rtb_Switch[1];
    rtb_Saturation = rtb_Product_j[2];
  }
  ...
  if (!(ctrl_student_HIL_B.SZ_Owerwrite > ctrl_student_HIL_P.Switch2_Threshold_p))
  {
    ...
    if (ctrl_student_HIL_B.kill_signal > ctrl_student_HIL_P.Switch1_Threshold) {
      ...
      rtb_Product_j[1] = rtb_safety_sig_3;
      rtb_Product_j[2] = rtb_Saturation;
    } else {
   ...
   */
  for (rtb_switch_sig = 0; rtb_switch_sig < 3; rtb_switch_sig++) {
    rtb_Switch[rtb_switch_sig] = rtb_R[3 * rtb_switch_sig + 2] * rtb_Product_j[2]
      + (rtb_R[3 * rtb_switch_sig + 1] * rtb_Product_j[1] + rtb_R[3 *
         rtb_switch_sig] * rtb_Product_j[0]);
  }

  /* End of Product: '<S11>/Product1' */

  /* MATLAB Function: '<S8>/Force Allocation' */
  /* MATLAB Function 'ThrustAllocationAndSaturation/Force Allocation': '<S25>:1' */
  if (ctrl_student_HIL_B.CurrentMode == 2.0) {
    /* '<S25>:1:5' */
    /* '<S25>:1:6' */
  ...
  /* End of MATLAB Function: '<S8>/Force Allocation' */
  ...
  /* '<S26>:1:3' */
  rtb_Saturation = sqrt(ctrl_student_HIL_B.f_vspx * ctrl_student_HIL_B.f_vspx +
                        ctrl_student_HIL_B.f_vspy * ctrl_student_HIL_B.f_vspy) /
    ctrl_student_HIL_P.Actuator_Sat_Forces_Value[0];

  /* '<S26>:1:4' */
  rtb_DeadZone = ctrl_student_HIL_B.f_bt /
  ...
  if (fabs(rtb_Saturation) > 1.0) {
    /* '<S26>:1:7' */
    /* '<S26>:1:8' */
    rtb_safety_sig_3 = 1.0 / fabs(rtb_Saturation);

    /* '<S26>:1:9' */
  } else if (fabs(rtb_DeadZone) > 1.0) {
    /* '<S26>:1:10' */
    /* '<S26>:1:11' */
    rtb_safety_sig_3 = 1.0 / fabs(rtb_DeadZone);
  ...
  /* '<S26>:1:18' */
  ctrl_student_HIL_B.u_vsp = rtb_Saturation * rtb_safety_sig_3;

  /* '<S26>:1:19' */
  ctrl_student_HIL_B.u_bt = rtb_DeadZone * rtb_safety_sig_3;

  /* End of MATLAB Function: '<S8>/Force2Control' */

  /* MATLAB Function: '<S8>/actForces' incorporates:
   *  Constant: '<S8>/Actuator_Sat_Forces'
   *  SignalConversion: '<S28>/TmpSignal ConversionAt SFunction Inport1'
   */
  /* MATLAB Function 'ThrustAllocationAndSaturation/actForces': '<S28>:1' */
  /* '<S28>:1:3' */
  /* '<S28>:1:4' */
  /* '<S28>:1:5' */
  /* '<S28>:1:7' */
  ...
  if (ctrl_student_HIL_B.TurnOffomega1 > ctrl_student_HIL_P.Switch_Threshold_j)
  {
    ...
    ctrl_student_HIL_B.Switch_b = rtb_Saturation;
  }
  ...
  tmp[8] = 1.0;
  for (rtb_switch_sig = 0; rtb_switch_sig < 3; rtb_switch_sig++) {
    ctrl_student_HIL_B.eta_dot[rtb_switch_sig] = 0.0;
    ctrl_student_HIL_B.eta_dot[rtb_switch_sig] += tmp[rtb_switch_sig] *
      rtb_Integrator[0];
    ctrl_student_HIL_B.eta_dot[rtb_switch_sig] += tmp[rtb_switch_sig + 3] *
      rtb_Integrator[1];
    ctrl_student_HIL_B.eta_dot[rtb_switch_sig] += tmp[rtb_switch_sig + 6] *
      rtb_Integrator[2];
  }
  ...
  for (rtb_switch_sig = 0; rtb_switch_sig < 3; rtb_switch_sig++) {
    rtb_Switch[rtb_switch_sig] = tmp_0[rtb_switch_sig + 6] * rtb_Integrator[2] +
      (tmp_0[rtb_switch_sig + 3] * rtb_Integrator[1] + tmp_0[rtb_switch_sig] *
       rtb_Integrator[0]);
  }
...
RT_MODEL_ctrl_student_HIL_T *ctrl_student_HIL(void)
{
  ...
  ctrl_student_HIL_M->Sizes.numBlocks = (186);/* Number of blocks */
  ctrl_student_HIL_M->Sizes.numBlockIO = (73);/* Number of block outputs */
  ctrl_student_HIL_M->Sizes.numBlockPrms = (434);/* Sum of parameter "widths" */
...
static NI_Parameter NI_ParamList[] DataSection(".NIVS.paramlist") =
{
  ...
  { 53, "ctrl_student_hil/ThrustAllocationAndSaturation/Constant/Value",
    offsetof(P_ctrl_student_HIL_T, Constant_Value_k), 38, 1, 2, 106, 0 },

  { 54, "ctrl_student_hil/ThrustAllocationAndSaturation/Ramp/Step/Before",
    offsetof(P_ctrl_student_HIL_T, Step_Y0), 38, 1, 2, 108, 0 },

  { 55, "ctrl_student_hil/ThrustAllocationAndSaturation/Saturation/UpperLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_UpperSat), 38, 1, 2, 110, 0 },

  { 56, "ctrl_student_hil/ThrustAllocationAndSaturation/Saturation/LowerLimit",
    offsetof(P_ctrl_student_HIL_T, Saturation_LowerSat), 38, 1, 2, 112, 0 },

  { 57, "ctrl_student_hil/ThrustAllocationAndSaturation/Switch/Threshold",
    offsetof(P_ctrl_student_HIL_T, Switch_Threshold_j), 38, 1, 2, 114, 0 },

  { 58, "ctrl_student_hil/ThrustAllocationAndSaturation/Constant1/Value",
    offsetof(P_ctrl_student_HIL_T, Constant1_Value), 38, 1, 2, 116, 0 },

  { 59, "ctrl_student_hil/ThrustAllocationAndSaturation/Switch1/Threshold",
    offsetof(P_ctrl_student_HIL_T, Switch1_Threshold_o), 38, 1, 2, 118, 0 },
};

static int NI_ParamListSize DataSection(".NIVS.paramlistsize") = 60;
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 55, "ctrl_student_hil/ThrustAllocationAndSaturation/Switch", 0, "", offsetof
    (B_ctrl_student_HIL_T, Switch_b)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 110,
    0 },
  ...
  { 57, "ctrl_student_hil/safety zone /MATLAB Function", 0, "kill_signal",
    offsetof(B_ctrl_student_HIL_T, kill_signal)+0*sizeof(real_T), BLOCKIO_SIG, 0,
    1, 2, 114, 0 },

  { 58, "ctrl_student_hil/physics_model/kinetics", 0, "nu_dot(1,1)", offsetof
    (B_ctrl_student_HIL_T, nu_dot)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 116,
    0 },

  { 59, "ctrl_student_hil/physics_model/kinetics", 0, "nu_dot(1,2)", offsetof
    (B_ctrl_student_HIL_T, nu_dot)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 118,
    0 },

  { 60, "ctrl_student_hil/physics_model/kinetics", 0, "nu_dot(1,3)", offsetof
    (B_ctrl_student_HIL_T, nu_dot)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 120,
    0 },

  { 61, "ctrl_student_hil/physics_model/kinematics", 0, "eta_dot(1,1)", offsetof
    (B_ctrl_student_HIL_T, eta_dot)+0*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 122,
    0 },

  { 62, "ctrl_student_hil/physics_model/kinematics", 0, "eta_dot(1,2)", offsetof
    (B_ctrl_student_HIL_T, eta_dot)+1*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 124,
    0 },

  { 63, "ctrl_student_hil/physics_model/kinematics", 0, "eta_dot(1,3)", offsetof
    (B_ctrl_student_HIL_T, eta_dot)+2*sizeof(real_T), BLOCKIO_SIG, 18, 1, 2, 126,
    0 },

  { 64, "ctrl_student_hil/joystick/Contoller_Map1", 0, "tau_surge", offsetof
    (B_ctrl_student_HIL_T, tau_surge)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2,
    128, 0 },

  { 65, "ctrl_student_hil/joystick/Contoller_Map1", 1, "tau_sway", offsetof
    (B_ctrl_student_HIL_T, tau_sway)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 130,
    0 },

  { 66, "ctrl_student_hil/joystick/Contoller_Map1", 2, "tau_yaw", offsetof
    (B_ctrl_student_HIL_T, tau_yaw)+0*sizeof(real_T), BLOCKIO_SIG, 0, 1, 2, 132,
    0 },

  { 67, "ctrl_student_hil/ThrustAllocationAndSaturation/actForces", 0,
    "tauAct(1,1)", offsetof(B_ctrl_student_HIL_T, tauAct)+0*sizeof(real_T),
    BLOCKIO_SIG, 18, 1, 2, 134, 0 },

  { 68, "ctrl_student_hil/ThrustAllocationAndSaturation/actForces", 0,
    "tauAct(1,2)", offsetof(B_ctrl_student_HIL_T, tauAct)+1*sizeof(real_T),
    BLOCKIO_SIG, 18, 1, 2, 136, 0 },

  { 69, "ctrl_student_hil/ThrustAllocationAndSaturation/actForces", 0,
    "tauAct(1,3)", offsetof(B_ctrl_student_HIL_T, tauAct)+2*sizeof(real_T),
    BLOCKIO_SIG, 18, 1, 2, 138, 0 },

  { 70, "ctrl_student_hil/ThrustAllocationAndSaturation/Force2Control", 0,
    "u_vsp", offsetof(B_ctrl_student_HIL_T, u_vsp)+0*sizeof(real_T), BLOCKIO_SIG,
    0, 1, 2, 140, 0 },

  { 71, "ctrl_student_hil/ThrustAllocationAndSaturation/Force2Control", 1,
    "alpha", offsetof(B_ctrl_student_HIL_T, alpha)+0*sizeof(real_T), BLOCKIO_SIG,
    0, 1, 2, 142, 0 },

  { 72, "ctrl_student_hil/ThrustAllocationAndSaturation/Force2Control", 2,
    "u_bt", offsetof(B_ctrl_student_HIL_T, u_bt)+0*sizeof(real_T), BLOCKIO_SIG,
    0, 1, 2, 144, 0 },

  { 73, "ctrl_student_hil/ThrustAllocationAndSaturation/Force Allocation", 0,
    "f_vspx", offsetof(B_ctrl_student_HIL_T, f_vspx)+0*sizeof(real_T),
    BLOCKIO_SIG, 0, 1, 2, 146, 0 },

  { 74, "ctrl_student_hil/ThrustAllocationAndSaturation/Force Allocation", 1,
    "f_vspy", offsetof(B_ctrl_student_HIL_T, f_vspy)+0*sizeof(real_T),
    BLOCKIO_SIG, 0, 1, 2, 148, 0 },

  { 75, "ctrl_student_hil/ThrustAllocationAndSaturation/Force Allocation", 2,
...
static char* NI_CompiledModelDateTime = "Wed Apr 05 16:00:52 2017";
